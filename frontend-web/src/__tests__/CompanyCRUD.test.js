...
describe('Company Component', () => {
  ...
  it('should add a company', async () => {
    ...
    */
    ...
    await waitFor(() => {
      expect(screen.getByDisplayValue('New Company')).toBeTruthy();
    });

  });

  it.skip('should edit a company', async () => {
    // Mock the response for fetching companies
    axios.get.mockResolvedValueOnce({ data: [] });
    ...
    await waitFor(() => {
      expect(screen.getByDisplayValue('New Company')).toBeTruthy(); // Ensure 'New Company' is no longer visible
